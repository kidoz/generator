...
void GeneratorApp::on_open(const Gio::Application::type_vec_files& files, const Glib::ustring& /*hint*/) {
...
void GeneratorApp::on_startup() {
    ...
    add_action("open-rom", sigc::mem_fun(*this, &GeneratorApp::on_action_open_rom));
    add_action("preferences", sigc::mem_fun(*this, &GeneratorApp::on_action_preferences));
    ...
    m_pause_action = add_action_bool("pause", sigc::mem_fun(*this, &GeneratorApp::on_action_pause), false);
