 ...
 * @param trg Target image buffer (must be pre-allocated: src_width * factor × src_height * factor)
 ...
 */
void xbrz_scale_custom(int factor,
                       const uint32_t* src, uint32_t* trg,
                       int src_width, int src_height,
                       double luminance_weight,
